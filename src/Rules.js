...
class SmallStraight extends Rule{
  evalRoll = dice => {
    ...
    const obj = new Set(dice); // create object with dice passed from the upper component; Game.js - ruleFn(dice)

    const scenario1 = obj.has(2) && obj.has(3) && obj.has(4) & (obj.has(1) || obj.has(5))
    const scenario2 = obj.has(3) && obj.has(4) && obj.has(5) & (obj.has(2) || obj.has(6))
